    ...
    <div id="table-nav">
        <table>
            <tr>
                ...
                <div class="form-group"><td><center><form name="2nd_toons" method="POST" action="./secondarycharacters.php"><input value="<?php echo $_SESSION['user_first']; ?>'s Secondary Checklists" type="submit"></form></td></div>
