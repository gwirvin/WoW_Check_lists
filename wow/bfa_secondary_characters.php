    ...
    <div id="table-nav">
        <table>
            <tr>
                ...
                <div class="form-group"><td><center><form name="all_toon" method="POST" action="./wow.php"><input value="All <?php echo $_SESSION['user_first']; ?>'s Characters" type="submit"></form></td></div>
