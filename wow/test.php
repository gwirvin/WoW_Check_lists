...
$myOauthArr = getOauthToken($blizzardOauthTokenUrl);
$myOauthToken = $myOauthArr['access_token'];
$apiToken = $_SESSION['access_token'];
$toon = "";
$toon_url = "";
$db_toon_count = "";
$db_toon_counter = 0;
...
print "var_dump of \$myOauthArr:\n<br>\n<pre>\n"; var_dump($myOauthArr); print "\n</pre>\n<br>\n<hr />\n<br>var_dump of \$myOauthToken:\n<br>\n<pre>\n"; var_dump($myOauthToken); print "\n</pre>\n<br>\n<hr />\n<br>var_dump of \$apiToken:\n<br>\n<pre>\n"; var_dump($apiToken); print "\n</pre>\n<br>\n<hr />\n<br>\n<br>\n<h2>Toon specific stuff</h2>\n<br>\n<hr />\n<br>";
...
while ($toon_result = mysqli_fetch_all($toon_query, MYSQLI_ASSOC)) {
	...
	$realmSlug = $toon_result[$db_toon_counter]['toon_realm'];
	//$toon_realm = $toon_result[$db_toon_counter]['toon_realm'];
	//$toonProfileUrl = $blizzardApiBase.$wowProfile.$realmSlug."/".$toonSlug.$wowProfileNamespace.$blizzardLocaleUs.$tokenPrefix.$api_key;
	//$toonProfileUrl = $blizzardApiBase.$wowProfile.$realmSlug."/".$toonSlug.$wowProfileNamespace.$blizzardLocaleUs.$tokenPrefix.$apiToken;
	$toonProfileUrl = $blizzardApiBase.$wowProfile.$realmSlug."/".$toonSlug.$wowProfileNamespace.$blizzardLocaleUs.$tokenPrefix.$myOauthToken;
	...
	//$toonILvl = $toonProfileObj->equipped_item_level;
