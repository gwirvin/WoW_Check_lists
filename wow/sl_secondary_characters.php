...
include "./includes/sl_2ndry_chk_lst.php";
...
<head>
    ...
    <title><?php echo $_SESSION['user_first']?>'s Shadowlands Secondary Characters</title>
...
<?php echo $nav_table?>
<div id="body"><body>
    <h2><center>World of Warcraft: Shadowlands Secondary Characters</center></h2>
    <div id="table-nav">
        <table>
            <tr>
