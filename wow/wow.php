...
<?php echo $nav_table?>
    <div id="table-nav"><table>
        <tr>
            ...
            <div class="form-group"><td><center><form name="legion" method="POST" action="./latest.php"><input value="<?php echo $_SESSION['user_first']; ?>'s Primary Checklist" type="submit"></form></td></div>
            <div class="form-group"><td><center><form name="toon" method="POST" action="./secondarycharacters.php"><input value="<?php echo $_SESSION['user_first']; ?>'s Secondary Checklist" type="submit"></form></td></div>
