...
<?php echo $nav_table?>
    <div id="table-nav"><table>
        <tr>
            ...
            <div class="form-group"><td><center><form name="pri_toons" method="POST" action="./latest.php"><input value="<?php echo $_SESSION['user_first']; ?> Primary Checklist" type="submit"></form></td></div>
            <div class="form-group"><td><center><form name="sec_toons" method="POST" action="./secondarycharacters.php"><input value="<?php echo $_SESSION['user_first']; ?> Secondary Checklist" type="submit"></form></td></div>
            <div class="form-group"><td><center><form name="toon" method="POST" action="./wow.php"><input value="All <?php echo $_SESSION['user_first']; ?>'s Characters" type="submit"></form></td></div>
