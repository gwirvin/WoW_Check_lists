...
<div id="body"><body>
<?php echo $nav_table?>
    <h2><center>World of Warcraft: Your Toons</center></h2>
    <div id="container">
	<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwkstOoT79_7bzLC3mhTgBDI3quM3ZBm3tR7VtEnf96HAg-SdVDQ" alt="Under Constructions">
    <p />
    <p />
    <p />
    </div>
