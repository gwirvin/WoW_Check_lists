...
// Variables that should really be empty on each loop's start
	...
	if ($toon_json === false) {
		$toon_table = "<h1><font color=\"ffffff\">Something has gone horribly wrong in getting information from blizzard</font></h1>";
		exit;
	} else {
...
#        } else {  
#	    $toon_table .= "<tr><td colspan=\"10\"><font color=\"FFFFFF\">Something has gone horribly wrong</td></tr>"; /* Trying to prevent massive error spamming */
        }
	$toon_table .= "\n</table>\n</div>\n";
    }
}
